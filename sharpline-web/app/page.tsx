...
import { getAgentReasoningLog, getAgentState, getCompletedMatches, getLatestLiveSignal, getLiveFixtures, getLiveSignalStats, getNextFixture, getOnChainAnchorLedger, getRecentLiveSignals } from "../lib/queries";
    ...
    <main>
      ...
      <div className="mx-auto max-w-7xl space-y-6 px-4 py-8 sm:px-6 lg:py-10">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <SignalCard signal={hasActiveMatch ? latestSignal : null} />
