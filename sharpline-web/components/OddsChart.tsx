...
export function OddsChart({ ticks }: { ticks: Tick[] }) {
  if (ticks.length === 0) {
    return <div className="flex h-[360px] items-center justify-center rounded-2xl border border-border bg-surface"><p className="text-sm text-text-muted">Connected to TxLINE. Odds movement will appear when live pricing updates begin.</p></div>;
  }
